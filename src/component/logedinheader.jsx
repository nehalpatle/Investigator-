        ...
        <>
                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12 col-sm-12 menu">
                        <nav>
                            <ul>
                                <li><NavLink to={'/pages/loginhome'} className={'nav'}><span><FaHome style={{ marginTop: "-5px" }} /></span>Home</NavLink></li>
                                <span style={{ color: "white" }}>|</span>
                                <li><NavLink to={'/pages/home'} className={'nav'}><span><BiLogIn style={{ marginTop: "-5px" }} /></span>Log-Out</NavLink></li>
                            </ul>
                        </nav>
                    </div>
                </div>
